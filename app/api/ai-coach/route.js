...
export async function POST(req) {
  try {
    ...
    if (type === 'analysis') {
      prompt = `
Сен нейрохирургия йўлидаги тиббиёт талабасининг шахсий AI мураббийсан. Стивен Ковининг "Муваффақиятли инсонларнинг 7 кўникмаси" китобидаги 2-квадрант (муҳим лекин шошилинч эмас) тамойили асосида таҳлил қил.
${STUDENT_CONTEXT}
Бугунги маълумотлар:
...
{ "score": <1-10>, "good": "<Ўзбек>", "bad": "<Ўзбек>", "tomorrow": "<Ўзбек>", "covey_analysis": "<2-квадрант ҳақида қисқа фикр>" }`;

    } else if (type === 'plan') {
      prompt = `
Сен Germany Path учун продуктивлик стратегисан. Дейл Карнегининг "day-tight compartments" (бугунги кун билан яшаш) тамойилини қўлла.
${STUDENT_CONTEXT}
Режа:
...
JSON: { "rating": "<X/10>", "critique": "<Ўзбек>", "suggestion": "<Ўзбек>" }`;
      ...
      prompt = `
${SYSTEM_PROMPT}
Марк Аврелийнинг "Meditations" китобидаги Стоик фалсафасини қўлла: фойдаланувчи назорат қила оладиган ва назорат қила олмайдиган нарсаларни ажратиб кўрсат.
...
Ўзбек Кирилл тилида, реал ва қаттиққўл лекин меҳрибон тарзда жавоб бер. Формат — текст, JSON эмас.`;
    ...
    } else if (type === 'validate_plan') {
      const tasks = data?.tasks || [];
      prompt = `
Сен Жавоҳирнинг қатъий Ислом коучисан. У 4-курс тиббиёт студенти, мақсади Германияда нейрохирург бўлиш.

Бугунги вазифалари:
${tasks.map((t, i) => `${i + 1}. "${t}"`).join('\n')}

Ҳар бир вазифани Стивен Ковининг Вақт Менежменти Матрицаси (Q1-Q4) бўйича таснифла.
Айниқса Q2 (Муҳим, лекин шошилинч эмас — Немецкий, Anki, илмий иш) борлигини текшир.
Агар Q2 вазифалар бўлмаса, "Ковининг 2-квадранти — айнан шу ерда нейрохирурглар етишади" деб таъкидла.

Ҳар бир вазифани текшир:
- Конкретми ёки умумийми? ("ўқиш", "тайёрланиш" — умумий, қабул қилинмайди)
- Реалистикми? Вақт ва куч жиҳатидан
- Нафс алдашига ўрин борми? (осон вазифалар ёзиб, қийинларидан қочмаяптими?)
- Германия мақсадига хизмат қиладими?

Ислом нуқтаи назаридан баҳола:
- Аллоҳ олдида жавоб берадиган одам каби режа туздими?
- Ё ўзини алдаяптими?
- Вақт — Аллоҳнинг амонати. Бу режа амонатга хиёнатми?

Агар режа суст ёки алдамчи бўлса — очиқ, қаттиқ айт. Мақтама.

JSON ФАҚАТ (бошқа матн йўқ):
{
  "approved": true/false,
  "critique": "Ҳар бир вазифа ҳақида аниқ фикр (ўзбек кирилл)",
  "islamic_note": "Ислом нуқтаи назаридан огоҳлантириш ёки тасдиқ (ўзбек кирилл)",
  "weak_tasks": ["умумий ёки суст вазифалар рўйхати"],
  "covey_warning": "Q2 вазифалар йўқлиги ҳақида огоҳлантириш (агар бўлса)"
}`;

    } else if (type === 'habit_review') {
      const weekLogs = data?.weekLogs || [];
      prompt = `
Сен Жавоҳир учун "Atomic Habits" (Жеймс Клир) бўйича экспертсан. Охирги 7 кунлик маълумотни таҳлил қил.
"Never miss twice" (ҳеч қачон икки марта кетма-кет ўтказиб юборма) қоидасини қўлла.
...
JSON форматда жавоб бер:
{
  "identity_statement": "Сен бўлажак нейрохирургсан...",
  "broken_chains": ["узилган одатлар"],
  "recovery_action": "Одатларни тиклаш учун қадам",
  "atomic_win": "Кичик ғалаба"
}`;
